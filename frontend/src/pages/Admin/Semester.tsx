...
import { type Semester } from '../../../../backend/src/semester/dto/semester.dto';
...
const AdminSemesterPage = () => {
  ...
  return (
    <>
      <PageWrapper title="Kelola Semester">
        ...
        <div className="bg-white rounded-2xl shadow-xl pb-6 px-4 md:px-6">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center mb-4 gap-4">
            <input
              ...
              className="border border-gray-200 rounded-lg px-4 py-2 w-full md:w-64 outline-none focus:outline-blue-300"
            />
          </div>
